// Adapted for headless Node use (original browser-worker setup removed --
// current pdfjs-dist's legacy/build/pdf.mjs needs neither a worker nor
// `canvas` for text-only extraction; see pdf.js's own examples/node/getinfo.mjs).
